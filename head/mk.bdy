...
# How to compile
ifeq ($(V), 1)
CC_OPTIONS += -fverbose-asm -save-temps
endif

CC_OPTIONS += -DLiS -D__KERNEL__ -DVERSION_2 $(CCREGPARM) $(XOPTS) $(OPT)
...
# - Enhanced to uninstall what is installed by the above install target 
uninstall:
...
clean: 
	...
	-$(Q)rm -f $(subst .o,.i,$(OBJS))
	-$(Q)rm -f $(subst .o,.s,$(OBJS))
	-$(Q)rm -f $(subst .o,.i,$(XOBJS))
	-$(Q)rm -f $(subst .o,.s,$(XOBJS))
