#!/usr/bin/perl -an
# $Id: nodeconfig.pl,v 9.1 2007/08/29 15:24:08 liu Exp $
#
...
#
# $Log: nodeconfig.pl,v $
# Revision 9.1  2007/08/29 15:24:08  liu
# PR# 10577 Check-in LiS directory name 2.18.1
# new file
#
...
BEGIN { 
	...
	print "# Auto-built from\n#\t$src\n# by $0\n", 
		'# $Header: /home/omni/RCS/Master/LiS/2.18.1/source/nodeconfig.pl,v 9.1 2007/08/29 15:24:08 liu Exp $', "\n", <<"EOF";
