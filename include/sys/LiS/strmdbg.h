...
void		 lis_print_buf(int num_buf) _RP;
...
#else
void	 lis_mark_mem_fcn(void *ptr, const char *file_name, int line_nr, int type) _RP;
#endif

#if defined(CONFIG_DEV) || !defined(USE_KMEM_CACHE)
#define	lis_mark_mem	lis_mark_mem_fcn

/* Defines for marking the Block Type */
#define BLK_MB_HOLD	0xaa1
#define BLK_MB_FREED	0xaa2
#define BLK_TIMER	0xaa3
#define BLK_HEAD	0xaa4
#define BLK_QUEUE	0xaa5
#define BLK_MB_PUTNEXT	0xaa6
#define BLK_MALLOC	0xaa7
#define BLK_FREE	0xaa8
#define BLK_MB_PUTQ	0xaa9
#define BLK_MB_PUTBQ	0xaaa
#define BLK_MB_GETQ	0xaab        
#define BLK_MB_HDR	0xaac
#define BLK_MB_DB	0xaad
