 ...
 * RCS Id          : $Id: msg.h,v 9.1 2007/08/29 15:29:21 liu Exp $
 ...
 *
 * Message headers are 128 bytes in size (256 on 64 bit platforms).
 * The extra space is used as the data buffer for smallish messages. 
 * This scheme means that in most cases, a call to allocb just
...
#ifdef _LP64
#define FASTBUF	(256-HDRSZ)		  /* space remaining for data	*/
#else
