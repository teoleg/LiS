...
common-clean:
	...
	-$(Q)rm -f $(subst .o,.s,$(DRVRS))
	-$(Q)rm -f $(subst .o,.i,$(DRVRS))
	-$(Q)rm -f $(subst .o,.s,$(TDRVRS))
	-$(Q)rm -f $(subst .o,.i,$(TDRVRS))
...
# - Enhanced to uninstall what is installed by the above common-install target 
common-uninstall:
